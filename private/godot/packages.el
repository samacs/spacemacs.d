;;; packages.el --- Major mode for editing Godot Engine GDScript files
;;
;; Copyright (c) 2012-2017 Sylvain Benner & Contributors
;;
;; Author: Saul Alejandro Martinez Castelo <samacs@cassiopeia.local>
...
;; added to `godot-packages'. Then, for each package PACKAGE:
;;
;; - If PACKAGE is not referenced by any other Spacemacs layer, define a
;;   function `godot/init-PACKAGE' to load and initialize the package.

;; - Otherwise, PACKAGE is already referenced by another Spacemacs layer, so
;;   define the functions `godot/pre-init-PACKAGE' and/or
;;   `godot/post-init-PACKAGE' to customize the package as it is loaded.

;;; Code:

(defconst godot-packages
  '()
  "The list of Lisp packages required by the godot layer.
